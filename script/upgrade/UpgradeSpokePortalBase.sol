...
abstract contract UpgradeSpokePortalBase is ScriptBase {
    function _upgradeSpokePortal(address portal_, address mToken_, address registrar_) internal {
        SpokePortal implementation_ = new SpokePortal(mToken_, registrar_);
